            ...
            html.Div([
                html.Div([
                    ...
                    figure={
                        'data' : 
                        [
                            {'x' : x, 'y' : y1, 'type' : 'line', 'name' : 'Positif', 'marker' : {'color' : colors['confirmed_text']}},
                            {'x' : x, 'y' : y2, 'type' : 'line', 'name' : 'Meninggal', 'marker' : {'color' : colors['deaths_text']}},
                            {'x' : x, 'y' : y3, 'type' : 'line', 'name' : 'Sembuh', 'marker' : {'color' : colors['recovered_text']}}
                        ],
                        'layout' : {
                            'plot_bgcolor' : colors['paper_color'],
                            'paper_bgcolor' : colors['paper_color'],
                            'font' : {'color' : colors['text']},
                            'title' : 'Grafik Total Perkembangan Covid-19 di Seluruh Dunia',
            ...
            html.Div([
                html.Div([
                    ...
                    dcc.Graph(
                        ...
                        figure={
                            'data': [
                            {'x' : x, 'y' : y2, 'type' : 'bar', 'marker' : {'color' : colors['deaths_text']}},
                            ],
                            'layout': {
                                        'plot_bgcolor' : colors['paper_color'],
                                        'paper_bgcolor' : colors['paper_color'],
                ...
                html.Div([
                    ...
                    dcc.Graph(
                        ...
                        figure={
                            'data': [
                            {'x' : x, 'y' : y3, 'type' : 'bar', 'marker' : {'color' : colors['recovered_text']}},
                            ],
                            'layout': {
                                        'plot_bgcolor' : colors['paper_color'],
                                        'paper_bgcolor' : colors['paper_color'],
                ...
                html.Div([
                    html.H6('Grafik Harian Perkembangan Covid-19 di Seluruh Dunia', style={'textAlign': 'center', 'color': 'white'}),
                    dcc.Graph(
                    id='tab_baru',
                    figure={
                        'data' : 
                        [
                            {'x' : x_daily, 'y' : y1_daily, 'type' : 'line', 'name' : 'Positif', 'marker' : {'color' : colors['confirmed_text']}},
                            {'x' : x_daily, 'y' : y2_daily, 'type' : 'line', 'name' : 'Meninggal', 'marker' : {'color' : colors['deaths_text']}},
                            {'x' : x_daily, 'y' : y3_daily, 'type' : 'line', 'name' : 'Sembuh', 'marker' : {'color' : colors['recovered_text']}}
                        ],
                        'layout' : {
                            'plot_bgcolor' : colors['paper_color'],
                            'paper_bgcolor' : colors['paper_color'],
                ...
                html.Div([
                    ...
                    figure={
                        'data' : 
                        [
                            {'x' : negara_nama, 'y' : negara_kasus, 'type' : 'bar', 'name' : 'Positif', 'marker' : {'color' : colors['confirmed_text']}},
                            {'x' : negara_nama, 'y' : negara_penambahan, 'type' : 'bar', 'name' : '+24 jam Terakhir', 'marker' : {'color' : 'white'}}
                        ],
                        'layout' : {
                            'plot_bgcolor' : colors['paper_color'],
                            'paper_bgcolor' : colors['paper_color'],
        ...
        html.Div([
                ...
                html.Div([
                    ...
                    figure={
                        'data' : 
                        [
                            {'x' : meninggal_negara_nama, 'y' : meninggal_negara_kasus, 'type' : 'bar', 'name' : 'Positif', 'marker' : {'color' : colors['deaths_text']}},
                            {'x' : meninggal_negara_nama, 'y' : meninggal_negara_penambahan, 'type' : 'bar', 'name' : '+24 jam Terakhir', 'marker' : {'color' : 'white'}}
                        ],
                        'layout' : {
                            'plot_bgcolor' : colors['paper_color'],
                            'paper_bgcolor' : colors['paper_color'],
